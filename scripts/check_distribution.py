...
PACKAGE_FILES = {
    ...
    "skills_auditor/lifecycle/engine.py",
    "skills_auditor/lifecycle/guards.py",
    "skills_auditor/lifecycle/locking.py",
    "skills_auditor/lifecycle/incidents.py",
    "skills_auditor/lifecycle/invocation.py",
    "skills_auditor/lifecycle/pending.py",
    "skills_auditor/lifecycle/repository.py",
    "skills_auditor/lifecycle/retention.py",
    "skills_auditor/lifecycle/snapshots.py",
    "skills_auditor/lifecycle/status.py",
    ...
    "skills_auditor/schemas/lifecycle-invocation-v1.schema.json",
    "skills_auditor/schemas/lifecycle-retention-plan-v1.schema.json",
    "skills_auditor/schemas/lifecycle-retention-receipt-v1.schema.json",
}
    ...
    required.update(
        {
            ...
            prefix + "README.md",
            prefix + "SKILL.md",
            prefix + "plugins/skill-trace/.codex-plugin/plugin.json",
            prefix + "plugins/skill-trace/hooks/hooks.json",
            prefix + "plugins/skill-trace/scripts/sensor_hook.py",
            prefix + "plugins/skill-trace/skills/skill-trace/SKILL.md",
            prefix + ".agents/plugins/marketplace.json",
            prefix + "docs/skill-trace.md",
            prefix + "config/skills-auditor.integration.example.json",
            prefix + "docs/integration-contract.md",
            prefix + "docs/managed-lifecycle.md",
            ...
            prefix + "tests/test_lifecycle_docs.py",
            prefix + "tests/lifecycle_model.py",
